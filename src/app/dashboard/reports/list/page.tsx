...
import { useCustom, useNavigation, useOne, usePermissions, useTable } from "@refinedev/core";
import Loader from "@components/common/Loader";
import GenericTable from "@components/Table/GenericTable";
import DnsRoundedIcon from "@mui/icons-material/DnsRounded";
import StateComponent from "@components/common/StateComponent";
import { Permission, Report } from "@/types/types";
...
const HomePage: React.FC = () => {
  ...
  const reportsData = data?.data.map((d) => ({
    ...d,
    created_at: getFormattedDate(d?.created_at as string),
    start_date: getFormattedDate(d?.start_date as string),
    end_date: getFormattedDate(d?.end_date as string),
  })) as Report[];
