...
const CustomTextField = React.forwardRef<HTMLInputElement, React.ComponentProps<typeof TextField>>(
    (props, ref) => (
        <TextField
            {...props}
            ref={ref}
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <div className='relative my-datepicker'>
                <div className='mb-1.5 block text-[#0000009c] font-medium dark:text-white absolute z-10 text-sm left-4 top-2'>
                    {label}
                </div>
                <DesktopDatePicker
