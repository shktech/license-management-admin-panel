  ...
  return (
    <GeneralInformation
      ...
      items={[
        ...
        {
          label: "Start Date",
          value: getFormattedDate(transaction?.asset?.start_date) || getFormattedDate(transaction?.start_date),
        },
        {
          label: "End Date",
          value: getFormattedDate(transaction?.asset?.end_date) || getFormattedDate(transaction?.end_date),
        },
        {
